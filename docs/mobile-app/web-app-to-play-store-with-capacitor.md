...
I had a working web application - [TableCommander](https://tablecommander.com), a web app for managing Magic: The Gathering game sessions. React frontend, NestJS backend. The question was whether I could get it into the Play Store without rewriting everything. Capacitor made that possible, and GitHub Actions made it repeatable.
